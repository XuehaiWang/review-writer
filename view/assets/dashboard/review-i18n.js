(function () {
  ...
  const EN_ZH = Object.freeze({
    ...
    "PDF, DOCX, Markdown, or TXT · headings are extracted into an editable candidate.": "支持 PDF、DOCX、Markdown 或 TXT；系统会提取标题并生成可编辑候选大纲。",
    "Extracting the reference outline...": "正在提取参考综述大纲……",
    ...
    "Generate Blueprint from Current Matrix and Outline": "根据当前文献矩阵与大纲生成章节蓝图",
    "Confirm Blueprint and Enter Sections": "确认章节蓝图并进入分节写作",
    "Current section outputs are ready for review.": "当前分节草稿已生成，可进行人工审核。",
    "Generate All Section Drafts": "生成全部分节草稿",
    "Confirm Sections and Enter Image Processing": "确认分节草稿并进入图像处理",
    "Generation Report": "生成报告",
    "Current section generation": "当前分节生成任务",
    "Jobs": "任务记录",
    "No generation job has been started.": "尚未启动分节生成任务。",
    "Current Section Drafts": "当前分节草稿",
    "Latest Job": "最近任务",
    "Current drafts are ready for human review.": "当前草稿已就绪，可进行人工审核。",
    "Section generation is running.": "正在生成分节草稿。",
    "Generate drafts from the current writing requirements.": "请根据当前写作要求生成草稿。",
    "Planning changed; regenerate sections.": "写作规划已更新，请重新生成分节草稿。",
    ...
    "Batch upload runs MinerU precise parsing, then builds searchable metadata and full-text Markdown.": "批量上传会执行 MinerU 精确解析，并生成可检索的元数据和全文 Markdown。",
  ...
  const PATTERNS = [
    ...
    [/^Uploading and running MinerU precise parsing (\d+)\/(\d+): (.+)$/, (m) => `正在上传并进行 MinerU 精确解析 ${m[1]}/${m[2]}：${m[3]}`],
