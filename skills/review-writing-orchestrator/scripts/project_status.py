...
STAGES: list[dict[str, Any]] = [
    ...
    {
        "id": "labkag_bridge",
        "name": "LabKAG ingest, taxonomy build, and topic-match export",
        "dir": "00_discovery",
        "skill": "labkag-review-skill",
        "required": [
            "topic_input.md",
        ...
        "human_check": "Check selected_discovery_results.json's local_papers list, then confirm human_check_state.json before literature-matrix-outline.",
