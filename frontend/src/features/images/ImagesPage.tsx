...
function FigureRedraw({ projectId, onBack }: { projectId: string; onBack: () => void }) {
  ...
  const outputLabel = row?.source_preserved
    ? text("保留的原图", "Retained source image")
    : text("重绘结果", "Redrawn output");
